					...
					<div className="flex items-start justify-between gap-4">
						<div>
							...
							<p className="text-gray-400 mt-2 text-lg">
								A component library where every button has
								feelings.
								<br />
						...
						<a
							href="https://github.com/indsigtdesign/emotional-ui"
							target="_blank"
							rel="noopener noreferrer"
							className="flex items-center gap-2 px-4 py-2 rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/20 transition-all text-sm font-medium"
